...
<body>
    ...
    <div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="#" style="padding:0px;">
                 <p>K Motors Limited Garage system</p>
                </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li id=""><a href="clients.php"><i class="glyphicon glyphicon-wrench"></i>Clients</a></li>        
		<?php } ?>
		<?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
        <li id=""><a href="schedule.php"> <i class="glyphicon glyphicon-th-list"></i>Schedule</a></li>        
		<?php } ?>
		<?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
        <li id=""><a href="feedback.php"> <i class="glyphicon glyphicon-th"></i> Feedback </a></li> 
		<?php } ?>
    <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
        <li id=""><a href="email.php"> <i class="glyphicon glyphicon-inbox"></i> Email </a></li> 
		<?php } ?>
		...
		<?php } ?> 
    <?php  if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
        <li id="vechile"><a href="vechile.php"> <i class="glyphicon glyphicon-road"></i>Vechile </a></li>
		<?php } ?>   
