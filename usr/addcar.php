      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <!-- Use the logged-in user's name as the driver -->
                <label for="exampleInputEmail1">User ID</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_driver" value="<?php echo $_SESSION['u_id']; ?>" readonly>
              </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="v_status" id="exampleFormControlSelect1" hidden>
