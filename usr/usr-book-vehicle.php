          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                <?php
                        $uid = $_SESSION['u_id']; // Get the logged-in user's ID
                        $ret = "SELECT * FROM tms_vehicle WHERE v_status ='Pending' AND v_driver = ?"; // Modify query to select vehicles with available status and the current user as the driver
